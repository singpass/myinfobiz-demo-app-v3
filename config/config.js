 ...
 */
let APP_CONFIG = { 
  DEMO_APP_CLIENT_ID: "STG2-MYINFOBIZ-SELF-TEST", 
  ...
  DEMO_APP_SCOPES : "basic-profile addresses appointments uinfin name sex race nationality dob email mobileno regadd housingtype hdbtype marital edulevel",
  MYINFO_API_AUTHORIZE: `https://${urlEnvironmentPrefix}api.myinfo.gov.sg/biz/v3/authorize`
};
...
let MYINFO_CONNECTOR_CONFIG = {
  ...
  TOKEN_URL: `https://${urlEnvironmentPrefix}api.myinfo.gov.sg/biz/v3/token`,
  PERSON_URL: `https://${urlEnvironmentPrefix}api.myinfo.gov.sg/biz/v3/entity-person`,
